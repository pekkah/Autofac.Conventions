namespace Autofac.Conventions.MarkerModel.Conventions
{
    ...
    public class TransientConvention : IRegistrationConvention
    {
            ...
            Type dependencyType)
        {
            ...
            foreach (Type itf in dependencyType.GetInterfaces().Where(i => i.HasInterface(typeof(ITransientDependency)))
                )
            {
        ...
        {
            return type.GetInterfaces().Any(i => i.HasInterface(typeof(ITransientDependency)));
        }
    }
}